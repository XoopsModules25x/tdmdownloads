        ...
        <{if $fields_count}>
            ...
            <{foreach item=field from=$fields_list}>
                <tr class="<{cycle values='odd, even'}>">
                    ...
                    <td class='center'>
                        <a href="field.php?op=update_status&amp;fid=<{$field.fid}>&aff=<{if $field.status == 1}>0"><img src="<{$pathModIcon16}>/on.png"><{else}>1"><img src="<{$pathModIcon16}>/off.png"><{/if}></a>
                    </td>
                    <td class='center'>
                        <a href="field.php?op=update_search&amp;fid=<{$field.fid}>&aff=<{if $field.search == 1}>0"><img src="<{$pathModIcon16}>/on.png"><{else}>1"><img src="<{$pathModIcon16}>/off.png"><{/if}></a>
                    </td>


                    <td class='center'>
                        <a href="field.php?op=edit_field&amp;fid=<{$field.fid}>"><img src="<{$pathModIcon16}>/edit.png" alt="<{$smarty.const._AM_TDMDOWNLOADS_FORMEDIT}>" title="<{$smarty.const._AM_TDMDOWNLOADS_FORMEDIT}>"></a>
                        <{if $field.status_def < 1}>
                            <a href="field.php?op=del_field&amp;fid=<{$field.fid}>"><img src="<{$pathModIcon16}>/delete.png" alt="<{$smarty.const._AM_TDMDOWNLOADS_FORMDEL}>" title="<{$smarty.const._AM_TDMDOWNLOADS_FORMDEL}>"></a>
                        <{/if}>
                    </td>
                </tr>
            <{/foreach}>
