        ...
        <{if $modified_count}>
            ...
            <{foreach item=modified from=$modified_list}>
                <tr class="<{cycle values='odd, even'}>">
                    ...
                    <td class='center'>
                        <a href="modified.php?op=view_downloads&downloads_lid=<{$modified.lid}>&amp;mod_id=<{$modified.requestid}>"><img src="<{$pathModIcon16}>/view_mini.png" alt="<{$smarty.const._AM_TDMDOWNLOADS_FORMDISPLAY}>" title="<{$smarty.const._AM_TDMDOWNLOADS_FORMDISPLAY}>"></a>
                        <a href="modified.php?op=del_moddownloads&amp;mod_id=<{$modified.requestid}>&amp;new_file=<{$modified.new_file}>"><img src="<{$pathModIcon16}>/ignore_mini.png" alt="<{$smarty.const._AM_TDMDOWNLOADS_FORMIGNORE}>" title="<{$smarty.const._AM_TDMDOWNLOADS_FORMIGNORE}>"></a>
                    </td>
                </tr>
            <{/foreach}>
            </tbody>
