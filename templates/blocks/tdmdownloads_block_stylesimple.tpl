            ...
            <div class='col-xs-12 col-sm-12 tdmdownloads-blockpanel'>
                ...
                <div class='tdmdownloads-blockcard'>
                    ...
                    <div class='tdmdownloads-blockbtns center'>
                        <p class="center">
                            <a class="btn btn-default" href="<{$xoops_url}>/modules/tdmdownloads/visit.php?lid=<{$downloads.lid}>" title='<{$smarty.const._MD_TDMDOWNLOADS_INDEX_DLNOW}>' target='_blank'><i class="glyphicon glyphicon-cloud-download tdmdownloads-blockbtn1"
