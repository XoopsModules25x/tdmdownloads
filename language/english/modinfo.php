...
define('_MI_TDMDOWNLOADS_MAXUPLOAD_SIZE_DESC', "The select is limited to the values of 'post_max_size' and 'upload_max_filesize' in your setting in php.ini<br>If you want to increase you have to increase these settings in php.ini first");
