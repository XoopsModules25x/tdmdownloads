...
Eine neue Datei "{FILE_NAME}" wurde in der Kategorie "{CATEGORY_NAME}" auf {X_SITENAME} eingesandt und wartet auf Freigabe.

Die wartende Datei kann hier eingesehen werden (beachte, dass ALLE wartenden Dateien in ALLEN Kategorien angezeigt werden):
{WAITINGFILES_URL}
